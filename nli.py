...
argparser.add_argument('--inference', default='resolution',
                       help='Inference algorithm (either resolution or modelChecking)')
argparser.add_argument(
    '--utterances', help='Utterances to load before the prompt')
argparser.add_argument(
    '--nltk', help='Use NLTK to analyze sentences', action='store_true', default=False)
argparser.add_argument(
    '--grammar', help='Which grammar to use', default='submission')
argparser.add_argument(
...
class NaturalLanguageInterface:
    ...
    def process(self, line):
        ...
        # Semantic parsing
        derivations = nlparser.parseUtterance(
